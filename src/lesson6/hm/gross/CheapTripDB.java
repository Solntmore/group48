...
public class CheapTripDB {
    ...
    public CheapTripDB() {
        ...
        addTour("Германия", "Берлин", "Автобус", 9, 135_000, 4,
                "все включено");
        addTour("Россия", "Алтай", "Поезд", 4, 78000, 5, "завтрак");
        addTour("Иран", "Шираз", "Самолет", 5, 80000, 4, "завтрак");
        addTour("Шри-ланка", "Коломбо", "Самолет", 10, 200_000, 5,
                "все включено");
    }
    ...
    public void getAllTours() {
        for (int toursIndex = 0; toursIndex < tours.length; toursIndex++) {
            String[] tour = tours[toursIndex];
            if (tour[0] == null) {
                return;
            }
