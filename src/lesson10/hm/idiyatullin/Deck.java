...
public class Deck {
   ...
   public Card getRandomCard() {             // ДЗ
      if (currentCardIndex == 0) {
         System.out.println("Все карты уже были выданы.");
         return null;
      }

      int randomIndex = (int) (Math.random() * currentCardIndex);
      Card selectedCard = cards[randomIndex];
      cards[randomIndex] = cards[currentCardIndex - 1];
