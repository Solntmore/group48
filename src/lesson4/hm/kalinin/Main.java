...
public class Main {
    public static void main(String[] args) {
        ...
        for (int verticalIndex2 = 0; verticalIndex2 < array.length; verticalIndex2++) {
            int[] nestedArray2 = array[verticalIndex2];
            for (int horizontalIndex = 0; horizontalIndex < nestedArray2.length; horizontalIndex++) {
                if (verticalIndex2 + horizontalIndex != 1 && verticalIndex2 + horizontalIndex != 3 &&
                        verticalIndex2 + horizontalIndex != 5 && verticalIndex2 + horizontalIndex != 7
                        && verticalIndex2 + horizontalIndex != 9) {
                    int number = array[verticalIndex2][horizontalIndex];
                    System.out.print(" " + number);
                } else {
                    System.out.print(" " + " ");
                }
